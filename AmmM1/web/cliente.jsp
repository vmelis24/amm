    ...
    <body>
        ...
        <table>
            ...
            <tr class="dati_d">
                ...
                <td><img src="M2/img/iphone.jpg" class="foto" title="iphone" alt="iphone 6s"></td>
                <td class="pezzi">2 </td>
                <td>€ 729,00</td>
            ...
            <tr class="dati_p">
                ...
                <td><img src="M2/img/s6.jpg" class="foto" title="samsung s6" alt="samsung s6" ></td>
                <td class="pezzi">1</td>
                <td>€ 699,99</td>
                <td class="carrello"><a href="riepilogo.jsp">Aggiugni al carrello</a></td>
            ...
            <tr class="dati_d" >
                ...
                <td><img src="M2/img/huawei.jpg" class="foto" title="huawei mate" alt="huawei mate" ></td>
                <td class="pezzi">3</td>
                <td>€ 599,99</td>
                <td class="carrello"><a href="riepilogo.jsp">Aggiugni al carrello</a></td>
            ...
            <tr class="dati_p">
                ...
                <td><img src="M2/img/microsoft.jpg" class="foto" title="microsoft lumia" alt="microsoft lumia"></td>
                <td class="pezzi">1</td>
                <td>€ 549,99</td>
                <td class="carrello"><a href="riepilogo.jsp">Aggiugni al carrello</a></td>
            ...
            <tr class="dati_d">
                ...
                <td><img src="M2/img/sony.jpg" class="foto" title="sony xperia" alt="sony xperia"></td>
                <td class="pezzi">2</td>
                <td>€ 569,00</td>
                <td class="carrello"><a href="riepilogo.jsp">Aggiugni al carrello</a></td>
