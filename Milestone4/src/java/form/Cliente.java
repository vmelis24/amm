...
public class Cliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session=request.getSession(false);
         ...
         ArrayList<UtentiClienti> listaClienti = UtentiFactory.getInstance().getUtentiClientiList();
          ...
          for(UtentiClienti u : listaClienti)
       {
         ...
         request.setAttribute("cliente", UtentiFactory.getInstance()
                .getVenditori((int)session.getAttribute("id")));
        ...
        request.getRequestDispatcher("cliente.jsp")
         ...
         if(session.getAttribute("isLogged").equals(false)){
          ...
          int idOggettiAcquistati = Integer.parseInt(request.getParameter("idOggettiAcquistati"));
        request.setAttribute("oggetti_acquistati", OggettiFactory.getInstance()
                .getObjectId(idOggettiAcquistati));
