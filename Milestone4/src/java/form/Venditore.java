...
public class Venditore extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       ArrayList<UtentiVenditori> listaVenditori = UtentiFactory.getInstance().getUtentiVenditoriList();
         
          for(UtentiVenditori u : listaVenditori)
       {
           if(u instanceof UtentiVenditori) 
         {
       request.setAttribute("venditore", UtentiFactory.getInstance()
        ...
        request.getRequestDispatcher("inserimentoOggetti.jsp").forward(request, response);
